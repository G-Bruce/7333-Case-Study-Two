...
# QQ PLOT: AGE
qqnorm(cbMen$age, main = "Q-Q Plot Age")
qqline(cbMen$age)
...
for (i in seq(from=1999, to=2012, by=1)){
  ...
  qqnorm(temp$age, main = paste("Q-Q Plot Age: ", i, sep=" "))
  qqline(temp$age)
}

# QQ PLOT: RUNTIME
qqnorm(cbMen$runTime, main = "Q-Q Plot runTime")
...
for (i in seq(from=1999, to=2012, by=1)){
  ...
  qqnorm(temp$runTime, main = paste("Q-Q Plot Runtime: ", i, sep=" "))
  qqline(temp$runTime)
}
